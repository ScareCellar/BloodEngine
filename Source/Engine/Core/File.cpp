...
namespace blood {
	namespace file {
        std::string GetCurrentDirectory() {
            std::error_code ec;
            auto path = std::filesystem::current_path(); //https://en.cppreference.com/w/cpp/filesystem/current_path.html
        ...
        bool SetCurrentDirectory(const std::string& path) {
            std::error_code ec;
            std::filesystem::current_path(path);//https://en.cppreference.com/w/cpp/filesystem/current_path.html
        ...
        std::string GetExtension(const std::string& path) {
            ...
            return p.extension().string(); //https://www.geeksforgeeks.org/cpp/how-to-extract-file-name-and-extension-from-a-path-in-cpp
        }

        std::string GetFilename(const std::string& path) {
            std::filesystem::path p(path);

            return p.filename().string(); //https://www.geeksforgeeks.org/cpp/how-to-extract-file-name-and-extension-from-a-path-in-cpp
        }
        ...
        bool WriteTextFile(const std::string& path, const std::string& content, bool append) {
            ...
            std::fstream fileout("file.txt", std::ios::out);
